    ...
    return {
      ...
      tools: [
        ...
        },
        {
          id: 7,
          name: 'VsCode',
          imageUrl: 'https://img.icons8.com/?size=100&id=9OGIyU8hrxW5&format=png&color=000000',
          status: 'Text Editor'
        },
        {
          id: 8,
          name: 'Android Studio',
          imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/c1/Android_Studio_icon_%282023%29.svg',
          status: 'Text Editor'
        },
        {
          id: 9,
          name: 'intellij idea',
          imageUrl: 'https://img.icons8.com/?size=100&id=61466&format=png&color=000000',
          status: 'Text Editor'
        },
        {
          id: 10,
          name: 'PgAdmin',
          imageUrl: 'https://www.myqnap.org/wp-content/uploads/cursoPgAdmin4.jpg',
          status: 'Database Management'
        },
        {
          id: 11,
          name: 'Postman',
          imageUrl: 'https://img.icons8.com/?size=100&id=EPbEfEa7o8CB&format=png&color=000000',
          status: 'Testing'
        },
        {
          id: 12,
    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-1/2 rounded-full mb-3 fadein-up"
            src="/img/pp.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Yosia Yehezkiel Gurning. I’m a Backend Developer, Mobile Developer, Software Engineer Student, and Web Developer. I really enjoy what I do right now; for me, creating programs is not just a job, but also an art that holds aesthetic value.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My role is to build applications and websites that are functional, user-friendly, and visually engaging. I always aim to give a personal touch to every product I work on, ensuring it not only runs smoothly but also captures attention and delivers the intended message effectively.
If you are interested in collaborating with me, feel free to get in touch through the contact provided.
          </p>
        </div>
